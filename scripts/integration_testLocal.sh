...
JEST_EXIT_CODE=0
jest TZ=utc NODE_ENV=test LOG_LEVEL=DEBUG jest ./tests/integration/controllers*/verifyEmailController*.test.ts --setupFiles dotenv/config --runInBand --verbose || JEST_EXIT_CODE=$?
